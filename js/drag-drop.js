...
function handleDrop(e) {
  ...
  // Hard-block invalid drops if allowed destinations were computed.
  ...
  // If workflow engine missing, fallback (shouldn’t happen in normal use)
    ...
    openReturnToQMOWReasonModal({
      ...
      onSubmit: (feedbackText) => {
        const ok = applyStatusChange(task, "qmow", {
          actor: "User A",
          reason: `Returned to QMOW from ${oldStatus.toUpperCase()} by User A (Drag & Drop). Feedback: ${feedbackText}`,
